...
##test
if (TEST == "TRUE") {
  peak_path = "/Users/shawn/SynologyDrive/Project/08.WheatLifeCycle/03.Progress/09.DAM/exp_mat.csv"
  group_path = "/Users/shawn/SynologyDrive/Project/08.WheatLifeCycle/03.Progress/09.DAM/group.csv"
  annotation_path = "/Users/shawn/SynologyDrive/Project/08.WheatLifeCycle/03.Progress/09.DAM/anno.csv"
  VIP_cut = 0;
  left = "CS.J3.C";
  right = "CS.J3.D";
  pval_cut = 0.05;
...
DAM_all = DM_analysis(
  ...
  left = left,
  right = right,
  method = "anova-test",method2 = "pls-da"
)
