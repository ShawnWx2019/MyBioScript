...
func(){
    ...
    echo -e "\033[35mrun_emmax_pipline \033[32m[-t tpedf_prefix] \033[31m[-o out_prefix] \033[31m[-p phenof] \033[31m[-k kinf] \033[31m[-c covf] \033[31m[-a anno] \033[33m[-i img_type] \033[33m[-s point_size] \033[33m[-w point_color]\033[0m"
    echo -e "\033[32m-------------------------------\033[0m"
    ...
    echo -e "\033[31m[-a]:anno\033[0m,  SNP annotation file by vep.\033[0m"
    echo -e "\033[32m-------------------------------\n\033[0m"
    ...
    echo -e "\033[33m[-w]:point_color\033[0m,  point size of manhattan plot, default: cut_off 4_6 ==> red_green.\033[0m"
    echo -e "\033[32m-------------------------------\n\033[0m"
    exit -1
}
